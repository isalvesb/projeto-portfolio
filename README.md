...
![Google Fonts](https://img.shields.io/badge/Google_Fonts-4285F4?style=flat-rounded&logo=googlefonts&logoColor=white) → Fornece a tipografia Poppins, garantindo um visual limpo, elegante e coerente com o estilo moderno do projeto.

![Design](https://img.shields.io/badge/Design-674695?style=flat-rounded&logo=adobecreativecloud&logoColor=white) → Aplicação de princípios de UI/UX para criar uma interface clara, equilibrada e intuitiva, com foco em hierarquia visual, contraste, espaçamento e experiência do usuário.
...
<table>
  <tr>
    <td align="center">
 <img src="https://github.com/user-attachments/assets/0c124ee7-4af7-43bb-a675-5a86dc632ca8" width="120px" style="border-radius: 50%;" alt="foto_perfil_Isa_Alves">
      <br>
      <b>Isa Alves</b>
      <br><br>
